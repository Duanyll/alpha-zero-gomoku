...
class NeuralNetWorkWrapper():
    ...
    def train(self, example_buffer, batch_size, epochs):
        ...
        dataloader = DataLoader(dataset, batch_size=batch_size, sampler=RandomSampler(dataset), num_workers=0, drop_last=False)
        ...
        for epo in range(1, epochs + 1):
            ...
            print("EPOCH: {}, LOSS: {}, ENTROPY: {}".format(epo, final_loss, final_entropy))
